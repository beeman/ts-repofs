...
export class TreeNode extends Record(DEFAULTS) {
  public static fromJS: (object) => any
  public static create: (value, children) => TreeNode
  public static createLeaf: (value) => TreeNode
  public static setIn: (tree, keySeq, node, options?: {}) => any
  public static getIn: (tree, keySeq) => any | any | null
  public static asImmutable: (tree) => any
  public static asMutable: (tree) => any
...
TreeNode.fromJS = function(object) {
  return TreeNode.create(
    object.value,
    Map(object.children).map(TreeNode.fromJS),
  )
}
...
function setIn(tree, keySeq, node, options: any = {}) {
...
function asImmutable(tree) {
  tree = Record.prototype.asImmutable.call(tree)
  const children = tree
    .getChildren()
    .map(asImmutable)
    .asImmutable()
...
function asMutable(tree) {
  ...
  return Record.prototype.asMutable.call(tree)
}
