...
import { Blob, Branch, WorkingState } from '../..'
...
export class Driver {
   ...
   * @return {Promise<Blob>}
   */
  public fetchBlob(sha): Promise<Blob> | void {
    console.log('fetchBlob sha', sha)
  }
   ...
   */
  public fetchWorkingState(ref): Promise<WorkingState> | void {}

  /**
   * Fetch branches listing
   * @return {Promise<List<Branch>>}
   */
  public fetchBranches(): Promise<List<Branch>> | void {}
   ...
   */
  public flushCommit(commitBuilder): Promise<Commit> | void {}
   ...
   */
  public listCommits(options): Promise<List<Commit>> | void {}
   ...
   * @return {Promise<Commit>}
   */
  public fetchCommit(sha): Promise<Commit> | void {}
   ...
   */
  public findParentCommit(ref1, ref2): any {
    return this.fetchComparison(ref1, ref2).then(
      compare => (compare.closest.sha ? compare.closest : null),
    )
  }
   ...
   */
  public fetchOwnCommits(base, head): any {
    return this.fetchComparison(base, head).then(compare => compare.commits)
  }
   ...
   */
  public fetchComparison(base, head): Promise<any> {
    return new Promise(() => {})
  }
